 ...
 */
package shashankp.cli.commands;
...
public class ShashankpCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ShashankpCliTestCommand.class);
    protected final ShashankpCliCommands service;

    public ShashankpCliTestCommand(final ShashankpCliCommands service) {
